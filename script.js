const distributions = [
    ...
    { name: "AV Linux MX Edition", version: "23.5 x64", icon: "img/distro/avlinux.png", downloadLink: "https://downloads.bandshed.net/AVL-MXe-23.5-GH/AVL_MXE_BASE-23.5_x64.iso", description: "A distro optimized for audio and video production.", websiteLink: "https://www.bandshed.net/avlinux/", category: "beginner"},
    ...
    { name: "Devuan", version: "5.0.0 amd64", icon: "img/distro/devuan.png", downloadLink: "https://ftp.fau.de/devuan-cd/devuan_daedalus/desktop-live/devuan_daedalus_5.0.0_amd64_desktop-live.iso", description: "A Debian-based distro without systemd.", websiteLink: "https://www.devuan.org/", category: "advanced"},
    { name: "MX Linux", version: "23.5 x64", icon: "img/distro/mxlinux.png", downloadLink: "https://sourceforge.net/projects/mx-linux/files/Final/Xfce/MX-23.5_x64.iso/download", description: "A Debian-based, lightweight, and user-friendly distro.", websiteLink: "https://mxlinux.org/", category: "beginner"},
    { name: "antiX", version: "23.2 x64", icon: "img/distro/antiX.png", downloadLink: "https://sourceforge.net/projects/antix-linux/files/Final/antiX-23.2/antiX-23.2_x64-full.iso/download", description: "A lightweight, systemd-free Debian-based distro.", websiteLink: "https://antixlinux.com/", category: "lightweight", torrent: "https://antixlinux.com/?sdm_process_download=1&download_id=3029"},
    { name: "Q4OS", version: "5.7 x64", icon: "img/distro/q4os.png", downloadLink: "https://sourceforge.net/projects/q4os/files/stable/q4os-5.7-x64-tde.r1.iso/download", description: "A lightweight distro with a classic UI.", websiteLink: "https://q4os.org/", category: "lightweight"},
    { name: "Kumander Linux", version: "2.0 amd64", icon: "img/distro/kumander.png", downloadLink: "https://www.kumander.org/download-kumander-linux#", description: "A distro inspired by good ol' Windows 7", websiteLink: "https://www.kumander.org/", category: "beginner"},
    { name: "Linux Lite", version: "7.2 x64", icon: "img/distro/linuxlite.png", downloadLink: "https://mirror.alpix.eu/linuxliteos/isos/7.2/linux-lite-7.2-64bit.iso", description: "A lightweight, user-friendly Ubuntu-based distro.", websiteLink: "https://www.linuxliteos.com/", category: "beginner", torrent: "https://mirror.alpix.eu/linuxliteos/isos/7.2/linux-lite-7.2-64bit.iso.torrent"},
    { name: "siduction", version: "2024.1.0 amd64", icon: "img/distro/siduction.png", downloadLink: "https://ftp.spline.de/pub/siduction/iso/Shine_on/kde/siduction-2024.1.0-Shine_on-kde-amd64-202412261719.iso", description: "A rolling-release distro with cutting-edge software.", websiteLink: "https://siduction.org/", category: "beginner"},
    ...
    { name: "Neptune", version: "8.1 x86_64", icon: "img/distro/neptune.png", downloadLink: "https://download.neptuneos.com/download/Neptune8-20240328.iso", description: "A Debian-based distro focused on multimedia and KDE.", websiteLink: "https://neptuneos.com/", category: "beginner"},
    ...
    { name: "DAT Linux", version: "2.0 amd64", icon: "img/distro/datlinux.png", downloadLink: "https://sourceforge.net/projects/dat-linux/files/datlinux-2.0-lxqt-desktop-amd64.iso/download", description: "An Ubuntu-based distro for data science.", websiteLink: "https://datlinux.com/", category: "advanced"},
    { name: "Kaisen Linux", version: "3.0 amd64", icon: "img/distro/kaisen.png", downloadLink: "https://iso.kaisenlinux.org/rolling/kaisenlinuxrolling3.0RC3-amd64-MATE.iso", description: "The distribution for professional IT.", websiteLink: "https://kaisenlinux.org/", category: "advanced", torrent: "https://torrent.kaisenlinux.org/kaisenlinuxrolling3.0RC3-amd64-MATE.iso.torrent"},
    { name: "Bodhi Linux", version: "7.0.0 x64", icon: "img/distro/bodhi.png", downloadLink: "https://sourceforge.net/projects/bodhilinux/files/7.0.0/bodhi-7.0.0-64.iso/download", description: "A lightweight distro featuring the Moksha desktop.", websiteLink: "https://www.bodhilinux.com/", category: "lightweight", torrent: "https://sourceforge.net/projects/bodhilinux/files/7.0.0/bodhi-7.0.0-64.iso.torrent/download"},
    { name: "Feren OS", version: "2023.04 x64", icon: "img/distro/ferenos.png", downloadLink: "https://sourceforge.net/projects/ferenoslinux/files/Feren-OS-standarddt.iso/download", description: "A user-friendly, Ubuntu-based distro.", websiteLink: "https://ferenos.weebly.com/", category: "beginner"},
    { name: "Vinari OS", version: "4.0.0 x64", icon: "img/distro/vinarios.png", downloadLink: "https://sourceforge.net/projects/vinari-os/files/HELIUM/Vinari-OS-4.0.0-HELIUM-x64.iso/download", description: "A user-friendly, Debian-based distro.", websiteLink: "https://vinarios.me/", category: "beginner"},
    { name: "Mabox Linux", version: "25.02 x64", icon: "img/distro/mabox.png", downloadLink: "https://sourceforge.net/projects/mabox-linux/files/latest/download", description: "A rolling-release customized Openbox wm distro.", websiteLink: "https://maboxlinux.org/", category: "lightweight"},
    { name: "instantOS", version: "7 x64", icon: "img/distro/instantos.svg", downloadLink: "https://github.com/instantOS/instantOS/releases/download/v7-beta/instantos_beta7.iso", description: "A lightning fast Arch-based distro.", websiteLink: "https://instantos.io/", category: "advanced"},
    ...
    { name: "MocaccinoOS", version: "1.8 amd64", icon: "img/distro/mocaccino.png", downloadLink: "https://github.com/mocaccinoOS/mocaccino/releases/download/v1.8/MocaccinoOS-GNOME-0.20250201.iso.tar.xz", description: "A minimal Linux meta-distribution.", websiteLink: "https://www.mocaccino.org/", category: "advanced"},
            ...
            <div class="card-body d-flex flex-column">
                ...
                <div class="mt-auto position-relative">
                    <div class="btn-container">
                        <a href="${distro.downloadLink}" class="btn btn-download flex-grow-1" rel="noopener noreferrer">
