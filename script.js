const distributions = [
    ...
    { name: "SteamFork", version: "20250204 x86_64", icon: "img/distro/steamfork.png", downloadLink: "https://www.steamfork.org/images/installer/steamfork-rel-latest-x86_64.iso", description: "SteamFork is a SteamOS-based operating system with improved hardware compatibility. It is designed to provide the same experience as SteamOS on a SteamDeck.", websiteLink: "https://github.com/SteamFork", category: "beginner"},
];
