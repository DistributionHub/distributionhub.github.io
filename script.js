const distributions = [
    { name: "Ubuntu", version: "24.04.1 LTS x86_64", icon: "img/distro/ubuntu.png", downloadLink: "https://releases.ubuntu.com/noble/ubuntu-24.04.1-desktop-amd64.iso", description: "User-friendly and popular Linux distribution.", websiteLink: "https://ubuntu.com/"},
    ...
    { name: "Debian", version: "12.8 x86_64", icon: "img/distro/debian.svg", downloadLink: "https://cdimage.debian.org/debian-cd/current/amd64/iso-cd/debian-12.8.0-amd64-netinst.iso", description: "Known for its stability and security.", websiteLink: "https://www.debian.org/"},
    ...
    { name: "Linux Mint", version: "22.1 x86_64", icon: "img/distro/mint.svg", downloadLink: "https://ftp.rz.uni-frankfurt.de/pub/mirrors/linux-mint/iso/stable/22.1/linuxmint-22.1-cinnamon-64bit.iso", description: "Ubuntu-based, user-friendly distribution.", websiteLink: "https://linuxmint.com/"},
    ...
    { name: "Rocky Linux", version: "9.5 x86_64", icon: "img/distro/rocky.svg", downloadLink: "https://download.rockylinux.org/pub/rocky/9/isos/x86_64/Rocky-9.5-x86_64-dvd.iso", description: "RHEL-compatible Linux distribution.", websiteLink: "https://rockylinux.org/"},
    { name: "openSUSE", version: "Leap 15.6 x86_64", icon: "img/distro/suse.png", downloadLink: "https://download.opensuse.org/distribution/leap/15.6/iso/openSUSE-Leap-15.6-NET-x86_64-Media.iso", description: "Versatile Linux with robust community support.", websiteLink: "https://www.opensuse.org/"},
    ...
    { name: "Kali Linux", version: "2024.4 x86_64", icon: "img/distro/kali.svg", downloadLink: "https://cdimage.kali.org/kali-2024.4/kali-linux-2024.4-installer-amd64.iso", description: "Powerful toolkit for ethical hacking and security.", websiteLink: "https://www.kali.org/"},
    ...
    { name: "CachyOS", version: "241221 x86_64", icon: "img/distro/cachy.svg", downloadLink: "https://cdn77.cachyos.org/ISO/desktop/241221/cachyos-desktop-linux-241221.iso", description: "Arch-based, optimized distribution for security.", websiteLink: "https://cachyos.org/"},
    ...
    { name: "Puppy Linux", version: "10.0.7 x86_64", icon: "img/distro/puppy.png", downloadLink: "https://rockedge.org/kernels/data/ISO/Bookworm_Pup64/BookwormPup64_10.0.7.iso", description: "Lightweight and highly portable Linux distribution.", websiteLink: "https://puppylinux-woof-ce.github.io/"},
    ...
    { name: "Pisi Linux", version: "2.4 x86_64", icon: "img/distro/pisi.png", downloadLink: "https://ftp.linux.org.tr/pisilinux/iso/kde/Pisi-Linux-2.4-KDE6-x86_64.iso", description: "A Turkish distro with its own package manager.", websiteLink: "https://pisilinux.org/"},
    { name: "deepin", version: "25 Preview x86_64", icon: "img/distro/deepin.svg", downloadLink: "https://cdimage.deepin.com/releases/25-preview/amd64/deepin-desktop-community-25-preview-amd64.iso", description: "A modern OS with a macOS-like deepin desktop.", websiteLink: "https://www.deepin.org/"},
    { name: "Tails", version: "6.11 x86_64", icon: "img/distro/tails.svg", downloadLink: "https://download.tails.net/tails/stable/tails-amd64-6.11/tails-amd64-6.11.img", description: "A Debian-based distribution focused on privacy.", websiteLink: "https://tails.net/"},
    ...
    { name: "Peppermint OS", version: "Deb x86_64", icon: "img/distro/peppermint.svg", downloadLink: "https://mirror.ossplanet.net/peppermint/iso/XFCE/PeppermintOS-Debian-64.iso", description: "A lightweight, cloud-focused Linux distribution.", websiteLink: "https://peppermintos.com/"},
    ...
    { name: "BunsenLabs", version: "240123 x86_64", icon: "img/distro/bunsenlabs.png", downloadLink: "https://ddl.bunsenlabs.org/ddl/boron-1-240123-amd64.hybrid.iso", description: "Lightweight, customizable, and minimalist Linux.", websiteLink: "https://www.bunsenlabs.org/"},
    { name: "Athena OS", version: "v23.11 x86_64", icon: "img/distro/athena.png", downloadLink: "https://github.com/Athena-OS/athena/releases/download/v23.11/athena-rolling-x86_64.iso", description: "Cybersecurity-focused, secure, and modern OS.", websiteLink: "https://athenaos.org/"},
