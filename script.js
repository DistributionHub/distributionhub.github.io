const distributions = [
    ...
    { name: "Debian", version: "12.8 x86_64", icon: "img/distro/debian.svg", downloadLink: "https://cdimage.debian.org/debian-cd/current/amd64/iso-cd/debian-12.8.0-amd64-netinst.iso", description: "Known for its stability and security.", websiteLink: "https://www.debian.org/", category: "advanced"},
    { name: "Arch Linux", version: "2024.11.01 x86_64", icon: "img/distro/arch.svg", downloadLink: "https://mirror.sunred.org/archlinux/iso/2024.11.01/archlinux-2024.11.01-x86_64.iso", description: "Minimalist and highly customizable distribution.", websiteLink: "https://archlinux.org/", category: "advanced"},
    ...
    { name: "Alpine Linux", version: "3.21.0 x86_64", icon: "img/distro/alpine.png", downloadLink: "https://dl-cdn.alpinelinux.org/alpine/v3.21/releases/x86_64/alpine-standard-3.21.0-x86_64.iso", description: "Lightweight & security-oriented Linux distribution.", websiteLink: "https://alpinelinux.org/", category: "lightweight"},
